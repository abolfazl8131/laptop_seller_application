...
describe('Sell Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Sell', () => {
      ...
      const sell = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(sell).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Sell', () => {
      const sell = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(sell).subscribe(resp => (expectedResult = resp.body));
