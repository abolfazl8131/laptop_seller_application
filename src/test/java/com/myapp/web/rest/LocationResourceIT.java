...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().city(DEFAULT_CITY).address(DEFAULT_ADDRESS);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().city(UPDATED_CITY).address(UPDATED_ADDRESS);
        return location;
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.city(UPDATED_CITY).address(UPDATED_ADDRESS);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.city(UPDATED_CITY).address(UPDATED_ADDRESS);
