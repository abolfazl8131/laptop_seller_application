...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().iD(DEFAULT_I_D).phoneNumber(DEFAULT_PHONE_NUMBER).name(DEFAULT_NAME);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().iD(UPDATED_I_D).phoneNumber(UPDATED_PHONE_NUMBER).name(UPDATED_NAME);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.iD(UPDATED_I_D).phoneNumber(UPDATED_PHONE_NUMBER).name(UPDATED_NAME);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.iD(UPDATED_I_D);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.iD(UPDATED_I_D).phoneNumber(UPDATED_PHONE_NUMBER).name(UPDATED_NAME);
